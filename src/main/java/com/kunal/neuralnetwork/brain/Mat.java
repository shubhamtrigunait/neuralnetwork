...
public class Mat implements Serializable, Cloneable {
     ...
     * @return A new neural.Mat with the addition of the elements
     */
     ...
     * Code:<br>
     * <code>
     * neural.Mat mat = new neural.Mat({ {1, 2}, {3, 4}, {5, 6} });<br>
     * mat = mat.transpose(); // Returns new neural.Mat<br>
     * </code>
     * neural.Mat will transpose like so:<br>
     * <code>
     * [<b>1</b>, 2]<br>
     * [3, <b>4</b>]<br>
     * [5, 6]<br>
     ...
     * </code>
     *
     * @return A new neural.Mat with the transposition of this
     */
     ...
     * @return A new neural.Mat with the multiplication of the parameter
     */
     ...
     * @return A new neural.Mat object with one column and each row and one
     * element.
     */
